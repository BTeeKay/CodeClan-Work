...
public class PirateserviceApplicationTests {
	...
	public void canFindRaidsByLocation() {
		List<Raid> found = raidRepository.findRaidsByLocation("Tortuga");
		System.out.println(found);
	}

	@Test
	public void canFindPiratesByRaidId() {
		List<Pirate> found = pirateRepository.findByRaidsId(1L);
	...
	@Test
	public void candFindShipByPirateFirstName() {
